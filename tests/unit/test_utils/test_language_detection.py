...
class TestLanguageDetector:
    ...
    def test_no_extension(self, filename, expected):
        ...
        language = self.detector.detect_language_from_filename(filename)
        assert language == expected, f"Failed for {filename}, expected {expected}, got {language}"
    ...
    def test_detect_from_content_javascript(self, content):
        ...
        assert language in ["javascript", None], f"Failed for content: {content[:30]}..., got {language}"
    ...
    def test_detect_from_content_java(self, content):
        ...
        assert language in ["java", "python", None], f"Failed for content: {content[:30]}..., got {language}"
    ...
    def test_detect_from_content_go(self, content):
        ...
        assert language in ["go", None], f"Failed for content: {content[:30]}..., got {language}"
    ...
    def test_detect_from_content_unknown(self, content):
        ...
        language = self.detector.detect_language_from_content(content)
        assert language is None, f"Failed for content: {content[:30]}..., expected None, got {language}"
    ...
    def test_filename_override_content(self):
        ...
        language = self.detector.detect_language_from_content(content)
        assert language in ["javascript", None], f"Expected 'javascript' or None, got {language}"
